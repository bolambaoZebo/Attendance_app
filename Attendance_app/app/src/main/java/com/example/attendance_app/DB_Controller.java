...
public class DB_Controller extends SQLiteOpenHelper {
    //databasename
    public static final String DATABASE_NAME = "attendace01.db";
    ...
    public boolean updateData(String id,String name,String typ,String price,String date) {
        ...
        db.update(EXPENSES_TABLE, contentValues, "ID = ?",new String[] { id });
        return true;
    }
    ...
    public boolean insertUser(String inames,String type, String iprice, String date) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
